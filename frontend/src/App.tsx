...
export default function App() {
  ...
  const [unifiedWorkspace, setUnifiedWorkspace] = useState(() => window.location.hash.startsWith('#/reviews/'));
        ...
        <div className="main-column">
          <header className="window-chrome">
            ...
            <div className="window-chrome-trailing">
              ...
              {!demoMode && <button type="button" className="demo-launch-button" onClick={() => { setUnifiedWorkspace((value) => !value); window.history.replaceState(null, '', unifiedWorkspace ? '#/' : '#/reviews/new'); }}>{unifiedWorkspace ? 'Legacy workspace' : 'New review workspace'}</button>}
