...
class ReviewWorkflowServiceRagIntegrationTest {
    ...
    void githubPrReadyRunsExactGroundedTraceWithoutLegacyIndexAndExcludesUngroundedPreview() {
        ...
        List<ReviewToolTraceEntity> traces = toolTraceRepository.findByReviewApiRunIdOrderBySequenceNumberAsc(response.getLatestRunId());
        ...
        assertThat(jdbcTemplate.queryForObject("SELECT COUNT(*) FROM rag_retrieval_trace WHERE review_api_run_id = ?",
                Integer.class, response.getLatestRunId())).isEqualTo(1);
