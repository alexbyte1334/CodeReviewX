...
class RagFindingQualityAcceptanceTest {
    ...
    @Autowired private ReviewWorkflowService service;
    ...
    @Autowired private ReviewApiRunRepository runRepository;
    @Autowired private ReviewIssueRepository issueRepository;
    @Autowired private ReviewApiRunRepository taskRepository;
