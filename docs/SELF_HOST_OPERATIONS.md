...
Before starting, configure PostgreSQL, GitHub, model, Embedding and Rerank readiness values in `.env`. Use a fresh database for the clean baseline and back up previous data before resetting it.
