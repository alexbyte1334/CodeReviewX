...
Use this script for a local demo (~10 minutes). Default mode uses the Mock provider — no API key required.
...
- **Default mode** uses deterministic mock findings for safe local demo.
